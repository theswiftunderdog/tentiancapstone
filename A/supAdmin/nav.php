...
<body>
  ...
  <!-- side nav -->
  <div class="sidenav">
  <img src="logoito.svg" alt="LOGO" id="disappear" width="50px">
    <ul id="sidenav">
      ...
      <li><a href="accounts.php" id="extra"><i class="bi bi-people"></i>Accounts </a></li>
      <li><a href="#" id="extra"><i class="bi bi-box-arrow-right"></i>Logout </a></li>
    </ul>
  </div>
