<?php
    ...
    // Retrieve customer data from the database with pagination
    $sql = "SELECT customer_id, full_Name,complete_address FROM customer LIMIT $offset, $recordsPerPage";
...
<body>
    ...
    <div class="admC-header"><h1>Customers</h1></div>
